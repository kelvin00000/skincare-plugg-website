                ...
                signupsCardsContainer.innerHTML+=`
                    <div class="signup-card">
                        <div class="top">
                            ...
                            <div class="user-username-container">${user.name}</div>
                        </div>
                        <div class="middle">
                            <div class="user-email-container">${user.email}</div>
                        </div>
                        <div class="bottom">
...
document.getElementById("search-singups-input").addEventListener('input', async (e) => {
    ...
    snap.forEach(async doc=>{
        ...
        if(currentEmail.includes(e.target.value.toLowerCase())) user = doc.data();

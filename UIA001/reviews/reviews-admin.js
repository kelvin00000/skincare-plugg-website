                ...
                <div class="review-card">
                    ...
                    <div class="mid">
                        ...
                        <div class="mid-bottom-row">
                            <div class="usercontact-conatiner">contact: <span>${review.userContact}</span></div>
                            <button class="js-open-user-whatsapp-chat" data-user-contact="${review.userContact}">
                                <svg class="js-open-user-whatsapp-chat" data-user-contact="${review.userContact}" width="25px" height="25px" viewBox="0 0 24 24" fill="#e3e3e3" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="js-open-user-whatsapp-chat" data-user-contact="${review.userContact}">WhatsApp</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="bottom">
                        <button class="js-confirm-review-delete" data-section-id="${sectionId}" data-product-id="${productId}" data-review-id="${reviewId}">
                            <span class="js-confirm-review-delete" data-section-id="${sectionId}" data-product-id="${productId}" data-review-id="${reviewId}">delete</span>
...
document.addEventListener('click', element => {
    if (element.target.classList.contains('js-open-user-whatsapp-chat')) {
        const userContact = element.target.dataset.userContact;
        window.open(`https://wa.me/+233${userContact}?text=${encodeURIComponent(msg)}`, '_blank');
    }
});

                                ...
                                <div class="bottom">
                                    <div class="left">
                                        ...
                                        <button class="add-to-cart-btn js-add-to-cart-btn" data-section-id="${productSecId}" data-product-id="${product.id}">
                                            Add to Cart
                                            <svg width="22px" height="22px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"/>
                                    ...
                                    <div class="right">
                                        <button class="buy-now-btn js-buy-now-btn" data-section-id="${productSecId}" data-product-id="${product.id}">Buy Now</button>
                                    </div>
                                </div>
                            </div>
                        `;

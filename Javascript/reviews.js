...
async function reactToReview(productId, reviewId, reaction) {
    ...
    await runTransaction(reviewRef, (review) => {
        ...
        let likes = review.likesCount || 0;
        let dislikes = review.dislikesCount || 0;
    ...
    return  `
            <div class="Popup-review-card">
                ...
                <div class="review-reaction-buttons">
                    ...
                    <div class="disliked-review-container">
                        <button>
                            <svg class="disliked-review" data-product-id="${productId}" data-review-id="${reviewId}" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M240-840h440v520L400-40l-50-50q-7-7-11.5-19t-4.5-23v-14l44-174H120q-32 0-56-24t-24-56v-80q0-7 2-15t4-15l120-282q9-20 30-34t44-14Zm360 80H240L120-480v80h360l-54 220 174-174v-406Zm0 406v-406 406Zm80 34v-80h120v-360H680v-80h200v520H680Z"/></svg>
                        </button>
                        <p class="js-disliked-review-counter">${review.dislikesCount}</p>
                    </div>
...
function attachReviewEvents(productId) {
    const popupReviewscontainer = document.querySelector(".Popup-review-cards-container");
